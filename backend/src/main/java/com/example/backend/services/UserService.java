...
public class UserService {
    ...
    public RegistrationResponseDto registerUser(RegistrationRequestDto registrationRequest) {
        ...
        welcomeMail(registrationRequest.getEmail());
    ...
    public void deleteAccount(String username, String jwt) {
        User user = userRepository.getUserByUsername(username);
        deleteAccountMail(user.getEmail());
    ...
    public void deleteAccountMail(String email) {
        Optional<User> optionalUser = userRepository.findUserByEmail(email);
        if (optionalUser.isEmpty() || !optionalUser.isPresent()) {
            return;
        }
        ...
        try {
            MailService.sendMail(email, "[Middle Earth Maps] Leaving the Fellowship!",
                    "<!DOCTYPE html>\n" +
                            "<html>\n" +
                            "    <head>\n" +
                            "        <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css\" integrity=\"sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T\" crossorigin=\"anonymous\">\n" +
                            ...
                            "        <h2>Hey!</h2>\n" +
                            "        <p>\n" +
                            "            Seems you've disappeared like Bilbo with the One Ring. Wishing you epic adventures wherever your path leads. Should you ever return, the Fellowship awaits!<br>\n" +
                            "            Best, <br>\n " +
                            "            Gandalf \uD83E\uDDD9\u200D♂ <br>\n" +
                            "        </p>\n" +
                            "    </body>\n" +
    ...
    public void welcomeMail(String email) {
        ...
        try {
            MailService.sendMail(email, "[Middle Earth Maps] Welcome to the Fellowship!",
                    "<!DOCTYPE html>\n" +
                            "<html>\n" +
                            "    <head>\n" +
                            "        <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css\" integrity=\"sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T\" crossorigin=\"anonymous\">\n" +
                            ...
                            "        <h2>Hey!</h2>\n" +
                            "        <p>\n" +
                            "            Congrats you are now part of the fellowship of the ring. Brace yourself for wild experiences on our website.<br>\n" +
                            "            Best, <br>\n " +
                            "            Gandalf \uD83E\uDDD9\u200D♂ <br>\n" +
                            "        </p>\n" +
                            "    </body>\n" +
